...
- **Why Minor, not Major**: it's real, multi-part engineering, but each individual piece (a cert-gen script, a Compose service, a zip-with-password script) is modest in isolation next to the other Majors in this table (a full game engine, a matchmaking system) — 1 point reflects that honestly. *(A case for Major could be made on combined scope — worth the team's own call.)*
